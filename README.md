这是为您准备好的 README.md 剩余内容，您可以直接将其复制粘贴到您图片中光标所在的位置。这段内容结合了开源社区的最佳实践，并严格基于您论文中的数据：
...
| **DBM-Con** | 目标检测 
 ...
 | <br>[HuggingFace](https://huggingface.co/DBM-65k) 
...
```bash
git clone https://github.com/zjw1176380908/Detection-Bridge-Model.git
